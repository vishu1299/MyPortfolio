...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative  text-gray-400 mb-10 bg-[#171A1E] shrink-0 mt-28 sm:mt-20 lg:mt-32 xl:mt-52 responsive-div">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-16 max-w-[90%] mx-auto px-6 py-14">
        <div>
          <h2 className="text-white text-3xl lg:text-6xl font-extrabold mb-4">
            LET'S TALK
          </h2>
          <button
            type="submit"
            className="theme-btn max-w-fit mt-5 p-2 text-sm font-bold  xl:text-xs mx-auto"
          >
        ...
        <div>
          ...
          <ul className="grid grid-cols-2 sm:grid-cols-4 sm:flex gap-4  mb-4">
            <li className="hover:text-white text-sm cursor-pointer">RESUME</li>
            <li className="hover:text-white text-sm cursor-pointer">
              PORTFOLIO
            </li>
            <li className="hover:text-white text-sm cursor-pointer">BLOG</li>
            <li className="hover:text-white text-sm cursor-pointer">CONTACT</li>
          </ul>
        ...
        <div>
          <h3 className="text-white font-bold text-2xl mb-4 ">Address</h3>
          <div className="flex flex-col gap-3">
            <p>8522 Preston Rd. Inglewood, Maine 98380</p>
            <p>help@gmail.com</p>
            <p>(907) 555-0101</p>
          </div>
        </div>
