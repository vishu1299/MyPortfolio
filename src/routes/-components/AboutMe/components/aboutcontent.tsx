function AboutContent() {
  return (
    <div className="flex justify-center items-center w-full">
      <div className="text-white pt-14 xl:w-full w-[90%]">
        <div className="flex flex-col gap-5">
          ...
          <div className="text-2xl xl:text-5xl font-extrabold leading-tight">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs xl:text-base font-normal text-[#C4CFDE] xl:w-[85%]">
              ...
              fast, accessible, and provide a seamless experience across
              devices.
            </p>
          </div>
        </div>
